...
class Countries {
  ...
  public static function usa_states() {
  ...
  public static function uk_counties () {
  
    return array("Aberdeenshire"=>"Aberdeenshire","Angus/Forfarshire"=>"Angus/Forfarshire","Argyllshire"=>"Argyllshire",
